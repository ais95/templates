					...
					<div class="col-md-12"> 
						<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
							...
							<div class="col-md-6 col-sm-12 pad">
								<input class="form-control" type="text" name="search_id" id="s_id" placeholder="Search By Your ID" required>
							</div>
						   ...
						   while($row = mysqli_fetch_assoc($result)) {
							?>
							   ...
							   <?php
								...
								echo  "<div class='alert alert-warning'> <h2><strong>Oops!</strong> Couldn't Found For <i> <b> ($sid)</b> </i></h2> </div>";
							}
